        ...
        return (
            <nav className="clndr-nav relative clear-fix">
                ...
                <div className="nav-box-ctn navigation">
                    <ul className="btn-ctn">
                        ...
                        <li id="prevBtn" className="nav-btn prev-btn vertical text-center" onClick={this.prevBtnHandler.bind(this)}>
                            <a href={undefined}><i className="fa fa-chevron-left" aria-hidden="true"></i></a>
                        </li>
                        <li id="nextBtn" className="nav-btn next-btn vertical text-center" onClick={this.nextBtnHandler.bind(this)}>
                            <a href={undefined}><i className="fa fa-chevron-right" aria-hidden="true"></i></a>
                        </li>
                    </ul>
                </div>
                ...
                <div className="nav-box-ctn nav-type">
                    <ul className="btn-ctn">
                        <li className={'nav-btn month-btn vertical text-center ' + (this.props.navType === 'month' ? 'active-nav-type' : '')}
                            onClickCapture={this.changeNavTypeHandler.bind(this)}><a href={undefined}>month</a></li>
                        <li className={'nav-btn week-btn vertical text-center ' + (this.props.navType === 'week' ? 'active-nav-type' : '')}
                            onClickCapture={this.changeNavTypeHandler.bind(this)}><a href={undefined}>week</a></li>
                    </ul>
                </div>
            </nav>
        );
